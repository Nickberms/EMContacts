    ...
    ModalNavigationDrawer(
        ...
        Box(
            ...
            Column(
                ...
                HomeHeader(drawerState, navController)
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Box(
                                ...
                                MedicsButton {
                                    selectedMunicipality?.let { municipality ->
                                        navController?.navigate("${Screen.MedicsScreen.route}/${municipality.name}")
                                    }
                                }
                            }
                            Box(
                                ...
                                FirefightersButton {
                                    selectedMunicipality?.let { municipality ->
                                        navController?.navigate("${Screen.FirefightersScreen.route}/${municipality.name}")
                                    }
                                }
                            }
                        }
                        ...
                        Row(
                            ...
                            Box(
                                ...
                                PoliceButton {
                                    selectedMunicipality?.let { municipality ->
                                        navController?.navigate("${Screen.PoliceScreen.route}/${municipality.name}")
                                    }
                                }
                            }
                            Box(
                                ...
                                RescuersButton {
                                    selectedMunicipality?.let { municipality ->
                                        navController?.navigate("${Screen.RescuersScreen.route}/${municipality.name}")
                                    }
                                }
                            }
                        }
